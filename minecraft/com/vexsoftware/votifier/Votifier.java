...
public class Votifier {
	...
	/** The logger instance. */
	public static final Logger logger = Logger.getLogger("Votifier");
	...
	public void preInit(FMLPreInitializationEvent event) {
		logger.info("[Votifier] Loading Votifier");
		...
		if (cfg.getString("port","").equals("")) {
			try {
				 ...
				 */
				logger.info("------------------------------------------------------------------------------");
				logger.info("Assigning Votifier to listen on port 8192. If you are hosting Craftbukkit on a");
				...
				logger.log(Level.SEVERE, "Error creating configuration file", ex);
				gracefulExit();
				return;
			}
		}
	...
	public void onEnable(FMLInitializationEvent event) {
		...
		logger.info("[Votifier] Loading vote listeners");
		String listenerDirectory = getDataFolder().toString() + File.separator + "listeners";
	...
	public void serverStarted(FMLServerStartedEvent event) {
		...
		logger.info("[Votifier] Starting listener on port " + port);
	...
	private void gracefulExit() {
		logger.log(Level.SEVERE, "Votifier did not initialize properly!");
	}
